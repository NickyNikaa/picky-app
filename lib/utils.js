...
export const CATEGORIES = [
  ...
  // Community & Culture
  { id: "community",      label: "💛 Community",          keywords: ["community", "treffen", "stammtisch", "meet up", "meetup"] },
  { id: "flinta-queer",   label: "🌈 FLINTA / Queer",     keywords: ["flinta", "queer", "lesbian", "lgbt", "lgbtq", "pride", "csd"] },
...
export function normalizeEvent({
  id, title, venueId, venueName, date, time, category, price, source, sourceUrl, pitch, imageUrl
}) {
  return {
